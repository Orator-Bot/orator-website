...
export default function Tos() {
  return (
    <div className="space-y-7 p-0 lg:p-6">
      ...
      <p className="text-sm text-white/70 mb-4">Created by Orator Team.</p>
      ...
      <div className="py-3"></div>
        <p>1. We don't allow usage of Orator for illegal uses. Making NSFW sounds and other type of TTS messages which
